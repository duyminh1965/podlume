...
const GenarateThumbnail = ({ setImage, setImageStorageId, image, imagePrompt, setImagePrompt }: GenerateThumbnailProps ) => {
  ...
  const getImageUrl = useMutation(api.podlume.getUrl);
        ...
        <div className="image_div" onClick={() => imageRef?.current?.click()}>
          ...
          {!isImageLoading ? (
            ...
            <div className='text-16 flex-center font-medium text-white-1'>
              Uploading
              <Loader size={20} className="animate-sprin" />
            </div>
          )}
...
export default GenarateThumbnail;